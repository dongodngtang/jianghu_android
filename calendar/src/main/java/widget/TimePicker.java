...
public class TimePicker extends LinearLayout{
	...
	private void init(Context context){
		...
		LayoutParams lparams_hours = new LayoutParams(0,LayoutParams.WRAP_CONTENT);
		lparams_hours.weight=1;
		...
		LayoutParams lparams_mins = new LayoutParams(0,LayoutParams.WRAP_CONTENT);
		lparams_mins.weight = 1;
		mins.setLayoutParams(lparams_mins);
