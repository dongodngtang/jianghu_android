package net.doyouhike.app.bbs.ui.widget.common.alertview;
...
public class AlertViewDialog extends Dialog {
    ...
    public AlertViewDialog(Context context, int themeResId) {
        super(context, themeResId);
    }

    protected AlertViewDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    public static class Builder {
        ...
        public AlertViewDialog create() {
            ...
            final AlertViewDialog dialog = new AlertViewDialog(context,
                    R.style.alertViewDailog);
            View layout = inflater.inflate(R.layout.dialog_alert_view, null);
            ...
            if (confirm_btnText != null) {
                ...
                layout.findViewById(R.id.cancel_btn).setBackgroundDrawable(BaseBitmapUtil.getDrawable(context, R.drawable.selector_alert_view_single_btn_select));
            }
            ...
            if (cancel_btnText != null) {
                ...
                layout.findViewById(R.id.second_line).setVisibility(View.GONE);
                layout.findViewById(R.id.confirm_btn).setBackgroundDrawable(BaseBitmapUtil.getDrawable(context, R.drawable.selector_alert_view_single_btn_select));
            }
