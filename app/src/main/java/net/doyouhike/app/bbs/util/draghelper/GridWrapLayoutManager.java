...
/**
 * 作者:luochangdong on 16/6/24 11:56
 * 描述:
 */
public class GridWrapLayoutManager extends android.support.v7.widget.GridLayoutManager {
    ...
    public GridWrapLayoutManager(Context context, int spanCount, int orientation, boolean reverseLayout) {
