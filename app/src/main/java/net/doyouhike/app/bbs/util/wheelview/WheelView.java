...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xDE000000;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0x3D000000;
	...
	private void initData(Context context) {
		...
		TEXT_SIZE = DensityUtil.dip2px(context, TEXT_SIZE);
		ITEM_OFFSET = DensityUtil.dip2px(context, ITEM_OFFSET);
	}
...
//			canvas.translate(this.getWidth() / 6, -ITEM_OFFSET);
			drawItems(canvas);
			drawValue(canvas);
			canvas.restore();
		}
