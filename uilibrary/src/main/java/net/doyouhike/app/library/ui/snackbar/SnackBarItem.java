...
public class SnackBarItem {
    ...
    private void getAttributes(Context context) {
        ...
        if (mSnackBarColor == Color.TRANSPARENT) mSnackBarColor = a.getColor(0, res.getColor(R.color.snack_bg));
        if (mAnimationDuration == -1) mAnimationDuration = a.getInt(1, 2000);
        ...
        if (mActionColor == Color.TRANSPARENT) mActionColor = a.getColor(3, res.getColor(R.color.snack_action));
