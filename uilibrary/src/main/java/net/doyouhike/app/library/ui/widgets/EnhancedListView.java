...
/**
 * A {@link ListView} offering enhanced features like Swipe To Dismiss and an
...
public class EnhancedListView extends ListView {
    ...
    /**
     * The callback interface used by {@link #setShouldSwipeCallback(OnShouldSwipeCallback)}
    ...
    /**
     * The callback interface used by {@link #setDismissCallback(OnDismissCallback)}
    ...
    private void init(Context ctx) {
        ...
        mUndoButton = (TextView) undoView.findViewById(R.id.undo);
     ...
     *
     * @throws IllegalStateException when you haven't passed an {@link OnDismissCallback}
     *                               to {@link #setDismissCallback(OnDismissCallback)} before calling this
     *                               method.
     */
     ...
     * {@link Undoable#discard()} might not be called for several items, what might
     ...
     * @throws IllegalStateException     when this method is called before an {@link OnDismissCallback}
     */
     ...
     * view will be dismissed by calling {@link #performDismiss(View, View, int)}.
     *
