...
import net.doyouhike.app.library.ui.netstatus.NetStateReceiver;
...
import net.doyouhike.app.library.ui.utils.SmartBarUtils;
...
public abstract class BaseAppCompatActivity extends AppCompatActivity {
     ...
     * @param eventCenter
     */
    protected abstract void onEvent(EventCenter eventCenter);
    ...
    public void showToast(String msg) {
        ...
        if (null != msg && !CommonUtils.isEmpty(msg)) {
            CommonUtils.showSnack(this, msg);
        }
    }
    ...
    public void setSystemBarTintAlpha(int resourceId, float alpha) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (null == mTintManager) {
                mTintManager = new SystemBarTintManager(this);
            }
