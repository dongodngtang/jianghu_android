...
public class PreferenceManager {
    ...
    private static String SHARED_KEY_CHAT_DRAFT = "SHARED_KEY_CHAT_DRAFT";
     ...
     * @param draft
     */
    public void setChatDraft(String toUser, String draft) {
        editor.remove(SHARED_KEY_CHAT_DRAFT + toUser);
        editor.putString(SHARED_KEY_CHAT_DRAFT + toUser, draft);
        editor.commit();
    }
     ...
     * @return
     */
    public String getChatDraft(String toUser) {
        return mSharedPreferences.getString(SHARED_KEY_CHAT_DRAFT + toUser, null);
    }
