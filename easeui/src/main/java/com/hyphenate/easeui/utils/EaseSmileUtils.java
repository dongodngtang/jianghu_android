...
public class EaseSmileUtils {
	...
	public static Spannable getSmiledText(Context context, CharSequence text,SmartTextCallback mSmartTextCallback) {
	    Spannable spannable = spannableFactory.newSpannable(text);
//		addSmiles(context, spannable);
		LinkifyHelper.addLinks(spannable,mSmartTextCallback, LinkifyHelper.WEB_URLS |LinkifyHelper.PHONE_NUMBERS );
	    return spannable;
	}
