...
public class EaseChatRowImage extends EaseChatRowFile {
    ...
    protected void onSetUpView() {
        ...
        if (message.direct() == EMMessage.Direct.RECEIVE) {
            if (imgBody.thumbnailDownloadStatus() == EMFileMessageBody.EMDownloadStatus.DOWNLOADING ||
                ...
                imageView.setBackgroundResource(R.color.default_image_background);
    ...
    protected void onBubbleClick() {
        Intent intent =  itemClickListener.bigImageActivity();
        ...
        if (file.exists()) {
            ...
            intent.putExtra("thumbPath",imgBody.thumbnailLocalPath());
        }
...
//        itemClickListener.showBigImage(imgBody);
    }
        ...
        if (bitmap != null) {
            ...
            new AsyncTask<Object, Void, Bitmap>() {
                ...
                protected Bitmap doInBackground(Object... args) {
                    ...
                    if (file.exists()) {
                        return BaseBitmapUtil.decodeScaleImage(thumbernailPath, 400, 400);
                    } else if (new File(imgBody.thumbnailLocalPath()).exists()) {

                        return BaseBitmapUtil.decodeScaleImage(imgBody.thumbnailLocalPath(), 400, 400);
                    } else {
                        if (message.direct() == EMMessage.Direct.SEND) {
                            if (localFullSizePath != null && new File(localFullSizePath).exists()) {
                                return BaseBitmapUtil.decodeScaleImage(localFullSizePath, 400, 400);
                            } else {
                                return null;
                            }
                        } else {
...
//            itemClickListener.displayImage(imgBody,iv);
            return true;
        }
    }
